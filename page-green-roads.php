...
<div class="pr_stripe" style="background-image:url('https://www.nutritionrealm.com/wp-content/uploads/2019/05/Header-Image.jpg');">
    <div class="pr_wrap">
        <div class="pr_column-50">
            <div class="pr_content" style="color:#FFF">
            ...
            <a href="https://greenroadsworld.com/?rfsn=796298.16944d" class="pr_cta">View Green Roads' Website</a>
        </div>
        </div>
        <div class="pr_column-50"></div>
    </div>
</div>

<div class="pr_stripe">
    <div class="pr_wrap pr_wrap_responsive">
        <div class="pr_column-70">
...
<div class="pr_stripe" style="background-image:url('https://www.nutritionrealm.com/wp-content/uploads/2019/05/Video-Image.jpg');margin-bottom:4em;">
    <div class="pr_content" style="height:380px;">
    <a href="https://greenroadsworld.com/?rfsn=796298.16944d" class="pr_cta" style="margin-top:4em;font-weight:bold">Shop Green Roads Products</a>
    </div>
</div>
...
<div class="pr_stripe">
    ...
    <div class="pr_column-50" style="background-image:url('https://www.nutritionrealm.com/wp-content/uploads/2019/05/GREENROADS__Fruit_Bites_Spring10-1.jpg');">
    </div>
    </div>
</div>
...
<div class="pr_stripe">
    <div class="pr_wrap">
    <div class="pr_column-50" style="background-image:url('https://www.nutritionrealm.com/wp-content/uploads/2019/05/JAA8765.jpg');">
    </div>
    <div class="pr_column-50">
        <div class="pr_content">
        <h2>Price</h2>
...
<div class="pr_stripe">
    ...
    <div class="pr_column-50" style="background-image:url('https://www.nutritionrealm.com/wp-content/uploads/2019/05/GR_Photoshoot2_Spring-53.jpg');">
    </div>
    </div>
</div>
...
<div class="pr_stripe">
    <div class="pr_wrap">
    <div class="pr_column-50" style="background-image:url('https://www.nutritionrealm.com/wp-content/uploads/2019/05/GR_Photoshoot2_Spring-129.jpg')">
    </div>
    <div class="pr_column-50">
        <div class="pr_content">
...
<div class="pr_stripe" style="background:rgb(228,234,241);">
    <div class="pr_content" style="padding:2em 2em 1em 2em;">
        <h1 style="text-align:center;">Our <strong>Green Roads</strong> Rating</h1>
    </div>
    <div class="pr_wrap pr_wrap_responsive">
        <div class="pr_column-50">
            <div class="pr_content" style="padding:1em 2em;background:#FFF;">
                <div class="pr_wrap">
                    <div class="pr_column-70" style="width:60%;padding:0">
                    ...
                    <div class="pr_column-30" style="width:40%">
                        <div class="pr_overall-rating" style="background-position:center;width:100%;height:100%;background-image:url(https://www.nutritionrealm.com/wp-content/uploads/2019/05/TFC19-NR-Rating-Icons-01.png);background-size:contain;background-repeat:no-repeat">
                            <h1>4.8</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="pr_content" style="padding:1em 2.5em 3em 2.5em;background:#FFF;">
                <h2><strong>Green Roads</strong> Detailed Rating</h2>
                <h3>Quality <span style="float:right;">5.0</span></h3>
                <div class="pr_wrap" style="justify-content:space-between;">
...
<div class="pr_stripe">
    <div class="pr_content" style="padding-bottom:.5em;padding-top:2em;">
        <h1 style="text-align:center;"><strong>Green Roads</strong> Customer Ratings</h1>
    </div>
    <div class="pr_wrap pr_wrap_responsive">
        <div class="pr_column-30">
            <div class="pr_content" style="padding-bottom:0;padding-top:0;">
